      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-white/10">
          ...
          <div className="space-y-3">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-teal-500/10 border border-teal-500/30 text-xs font-semibold text-teal-400">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 text-center sm:text-left">
          ...
          <p className="text-[11px] font-mono text-slate-400 uppercase">
            BIOCORE RESEARCH LLP • TRANSLATIONAL DEEP-SCIENCE
          </p>
        </div>
      </div>
    </footer>
